...
```bash
claudio@claudio:~$ ls -l /usr/bin/ > ls-output.txt
claudio@claudio:~$ less ls-output.txt
.....
```
...
```bash
claudio@claudio:~$ ls -l /bin/usr > ls-output.txt
ls: cannot access '/bin/usr': No such file or directory
claudio@claudio:~$ ls -l ls-output.txt
